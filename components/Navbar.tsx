...
export default function Navbar() {
  ...
  return (
    <header className="w-full fixed top-0 z-50 bg-blue-400 backdrop-blur-md border-b border-gray-200 shadow-sm">
        ...
        <nav className="hidden md:flex space-x-6">
          {links.map(({ href, label }) => (
            <Link
              key={href}
              href={href}
              className="text-gray-900 hover:text-gray-500 transition font-medium"
            >
              {label}
            </Link>
          ))}
